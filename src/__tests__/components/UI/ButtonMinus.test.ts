/**
 * Tests for ButtonMinus component
 */
...
jest.mock('phaser', () => {
	...
	class MockSprite {
		...
		constructor(scene: any, x: number, y: number, texture: string) {
			...
			this.anims = { currentAnim: { key: 'touch_button_minus' } };
...
describe('ButtonMinus', () => {
	...
	describe('Constructor', () => {
		it('should create button with correct position', () => {
			const button = new ButtonMinus(mockScene, 100, 200, 'testAction', { test: true });
		...
		it('should add button to scene', () => {
			new ButtonMinus(mockScene, 100, 200, 'testAction', { test: true });
	...
	describe('Pointer Down Handler', () => {
		it('should execute action when clicked', () => {
			...
			const button = new ButtonMinus(mockScene, 100, 200, 'testAction', args);
		...
		it('should call play with animation config when clicked', () => {
			const button = new ButtonMinus(mockScene, 100, 200, 'testAction', {});
			...
			expect(playSpy).toHaveBeenCalledWith({ key: 'touch_button_minus' });
		});
	});
	...
	describe('Integration', () => {
		it('should work with different action names', () => {
			const button1 = new ButtonMinus(mockScene, 100, 200, 'removeAttribute', {});
			const button2 = new ButtonMinus(mockScene, 150, 200, 'decreaseValue', {});

			// Trigger handlers
			(button1 as any).emit('pointerdown', {});
			(button2 as any).emit('pointerdown', {});

			expect(mockExecuteFunctionByName).toHaveBeenCalledWith('removeAttribute', mockScene, {});
			expect(mockExecuteFunctionByName).toHaveBeenCalledWith('decreaseValue', mockScene, {});
		});
		...
		it('should pass complex args to action', () => {
			...
			const button = new ButtonMinus(mockScene, 100, 200, 'testAction', complexArgs);
			(button as any).emit('pointerdown', {});
		...
		it('should handle null args', () => {
			const button = new ButtonMinus(mockScene, 100, 200, 'testAction', null);
			(button as any).emit('pointerdown', {});
		...
		it('should create multiple buttons independently', () => {
			const button1 = new ButtonMinus(mockScene, 100, 200, 'action1', { id: 1 });
			const button2 = new ButtonMinus(mockScene, 200, 200, 'action2', { id: 2 });
			const button3 = new ButtonMinus(mockScene, 300, 200, 'action3', { id: 3 });
